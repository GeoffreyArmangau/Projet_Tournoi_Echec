class MatchesController:
    ...
    def get_winner(self, match):
        ...
        if match.score1 > match.score2:
            return f'{
                match.player1.first_name} gagne le match contre {
                match.player2.first_name}'
        elif match.score1 < match.score2:
            return f'{
                match.player2.first_name} gagne le match contre {
                match.player1.first_name}'
        else:
            return f'Égalité entre {
                match.player1.first_name} et {
                match.player2.first_name}'
