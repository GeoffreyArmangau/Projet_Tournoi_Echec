class TournamentsViews:
    def __init__(self, tournaments_controller, players_controller, rounds_controller):
    ...
    def create_new_tournament(self):
        ...
        if self.tournaments_controller:
            tournament = self.tournaments_controller.create_tournament(name, location, beginning_date, end_date, int(number_of_rounds), description)
    ...
    def register_players_to_tournament(self):
        ...
        success, message = self.players_controller.add_player_to_tournament(selected_tournament, selected_player)
