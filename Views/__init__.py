...
class ViewsManager:
    ...
    def __init__(
            ...
            reports_controller):
        """
        Initialise le gestionnaire avec les contrôleurs spécialisés
        et les vues spécialisées
        """
        ...
        self.tournaments_views = TournamentsViews(
            tournaments_controller, players_controller, rounds_controller)
        self.reports_views = ReportsViews(
            reports_controller, tournaments_controller)
    ...
    def handle_choice(self, choice):
        ...
        return self.main_views.handle_choice(
            choice,
            self.players_views,
            self.tournaments_views,
            self.reports_views)
