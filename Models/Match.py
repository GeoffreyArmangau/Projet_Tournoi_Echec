...
class Match:
    ...
    """
    def __init__(self, player1, player2, score1=0, score2=0, player1_color=None, player2_color=None):
        """
    ...
    def get_match_display(self):
        ...
        """
        player1_display = f"{self.player1.first_name} {self.player1.last_name} ({self.player1_color})"
        player2_display = f"{self.player2.first_name} {self.player2.last_name} ({self.player2_color})"
