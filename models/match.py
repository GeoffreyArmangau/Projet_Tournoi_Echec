...
class Match:
    ...
    def __init__(
            ...
            player2_color=None):
        """
        Initialise un match entre deux joueurs avec scores et couleurs.
    ...
    def get_match_display(self):
        """
        Retourne une chaîne formatée représentant le match avec les couleurs des joueurs.
        """
        player1_display = f"{
    ...
    def Match_Dictionary(self):
        """
        Retourne un dictionnaire représentant le match pour la sérialisation JSON.
        """
        return {
