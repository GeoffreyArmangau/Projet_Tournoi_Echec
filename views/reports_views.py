class ReportsViews:
    """
    Gère l'affichage et la navigation des rapports sur les joueurs et tournois.
    """
    def __init__(self):
        """
    ...
    def display_reports_menu(self):
        """
        Affiche le menu spécialisé pour la gestion et la consultation des rapports.
        """
    ...
    def tournaments_report(self):
        """
        Affiche un rapport synthétique sur tous les tournois enregistrés.
        """
    ...
    def tournaments_info_report(self):
        """
        Affiche les informations détaillées d'un tournoi sélectionné par l'utilisateur.
        """
